...
import (
	...
	"github.com/HeRoMo/go_todo_app/testutil/fixture"
...
func TestJWTer_GetToken(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
		...
		Issuer(`github.com/HeRoMo/go_todo_app`).
	...
	if !reflect.DeepEqual(got, want) {
		t.Errorf("GotToken() got = %v, want %v", got, want)
	}
}
