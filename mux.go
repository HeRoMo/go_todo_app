...
import (
	...
	"github.com/HeRoMo/go_todo_app/auth"
	"github.com/HeRoMo/go_todo_app/clock"
	"github.com/HeRoMo/go_todo_app/config"
	"github.com/HeRoMo/go_todo_app/handler"
	"github.com/HeRoMo/go_todo_app/service"
...
func NewMux(ctx context.Context, cfg *config.Config) (http.Handler, func(), error) {
	...
	mux.Post("/register", ru.ServerHTTP)
